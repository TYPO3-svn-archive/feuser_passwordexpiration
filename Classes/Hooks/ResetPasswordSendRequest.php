 ...
 */
class tx_FeuserPasswordexpiration_Hooks_ResetPasswordSendRequest extends Tx_FeuserPasswordexpiration_Hooks_AbstractHook implements tx_eft_domain_model_observer_observer {
	/**
	 * update fe-user
